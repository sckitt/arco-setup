...
globalkeys = gears.table.join(
    ...
    awful.util.spawn("/home/user/src/tor-browser_en-US/Browser/start-tor-browser") end,
              {description = "run tor", group = "applications"}),
    ...
    awful.key({ modkey }, "r", function()
   	awful.util.spawn("rofi -show run -lines 6 -theme Arc-Dark") end,
...
awful.spawn.with_shell("imsettings-switch -n -q -x")
